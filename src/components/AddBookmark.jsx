    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">Add Bookmark</h2>
          ...
          <div className="mb-4">
            <div className="flex flex-wrap gap-1.5 mb-2">
              {tags.map((tag) => (
                ...
                >
                  {tag}
                  <button type="button" onClick={() => removeTag(tag)} className="hover:text-zinc-900 dark:hover:text-zinc-100 cursor-pointer">
                    <X size={10} />
                  </button>
                </span>
              ))}
